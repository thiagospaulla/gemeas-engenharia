...
export default function ClientViewWorkDiaryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchDiary = async (token: string, id: string) => {
    try {
      ...
      if (data.workDiary) {
        ...
        router.push('/client/work-diaries')
      }
    } catch (error) {
          ...
          <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Atualização da Obra - {formatDate(diary.date)}
              </h1>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      Fotos do Dia ({diary.photos.length})
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                        ...
                        <div key={index} className="group relative overflow-hidden rounded-lg border border-gray-200">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
                            <p className="text-sm text-white font-medium">
                              Foto {index + 1} de {diary.photos.length}
                            </p>
                          </div>
                        </div>
                      ))}
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button 
                      ...
                      onClick={() => router.push(`/client/projects/${diary.project.id}`)}
                    >
                      Ver Projeto
                    </Button>
                  </CardContent>
                  ...
                  {diary.workersPresent && (
                    <div className="flex items-center gap-3 rounded-lg border border-gray-200 p-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{diary.workersPresent} trabalhadores</p>
                      </div>
                    </div>
                  )}
                </CardContent>
